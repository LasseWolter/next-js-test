...
// NOTE: Workaround to make it work with supabase
// seems like you are not supposed to use vercel/postgres with supbase anymore 
// you should use the supabase client instead
